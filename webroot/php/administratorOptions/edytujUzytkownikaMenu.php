...
if (isset($_POST['button_edytujUzytkownika']) && isset($_POST['txt_uzytkownik']) && isset($_POST['txt_haslo']) && isset($_POST['uprawnienia'])) {
    ...
    try {
        ...
        $_SESSION["returnMessageString"] = "Zmieniono użytkownika: " . $uzytkownik . "<br>";

        $stmt->close();
        $log = "zmieniono użytkownika: " . $uzytkownik;
        $sql = "call logujDane(?, ?);";
        try {
            $stmt = $conn->prepare($sql);
        ...
        $_SESSION["returnMessageString"] = "Nie Zedytowano/Błąd";
    }
...
<html>
    ...
    <body>
        ...
        <form method='post'>
            ...
            <input type="submit" value="zatwierdź" name="button_edytujUzytkownika">
        </form>
        <p>
            <?php
